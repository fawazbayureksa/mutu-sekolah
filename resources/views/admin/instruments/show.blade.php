...
@section('content')
                                ...
                                @foreach ($instrument->items as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small
                                                class="text-muted">{{ Str::limit($item->question->question_text, 80) }}</small>
                                        </td>
                                        <td>
                                            <span
                                                class="badge bg-light text-dark">{{ $item->question->answer_type }}</span>
                                        </td>
                                        <td>
    ...
    <div class="card mt-3">
        ...
        <div class="card-body d-flex flex-column gap-2">
            ...
            @endif
            <form action="{{ route('admin.instruments.duplicate', $instrument) }}" method="POST" @csrf <button
