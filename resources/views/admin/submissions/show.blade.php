        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @foreach ($aspects as $aspect)
                    <div class="mb-5">
                        <h4 class="text-primary border-bottom pb-2 mb-3">{{ $aspect->code }} - {{ $aspect->name }}</h4>

                        @foreach ($aspect->indicators as $indicator)
                            <div class="card mb-4 border-left-primary">
                                <div class="card-header bg-light">
                                    <span class="badge bg-secondary me-2">{{ $indicator->code }}</span>
                                    <span class="fw-bold text-dark">{{ $indicator->description }}</span>
                                </div>
                                <div class="card-body">
                                    @foreach ($indicator->questions as $question)
                                        ...
                                        <div class="mb-4 pb-3 border-bottom last:border-0">
                                            <div class="d-flex align-items-start mb-2">
                                                <span class="badge bg-info me-2 mt-1">{{ $question->question_code }}</span>
                                                <div>
                                            ...
                                            <div class="ms-4 p-3 bg-light rounded mt-2">
                                                ...
                                                @else
                                                    ...
                                                    @elseif ($question->answer_type === 'boolean')
                                                        @if (strtolower($response->answer) == 'yes' || $response->answer == '1')
                                                    ...
                                                    @elseif (in_array($question->answer_type, ['scale', 'multiple_choice']))
                                                        ...
                                                        @if ($label !== $response->answer)
                                                            <small class="text-muted">({{ $response->answer }})</small>
                                                        @endif
                                                    @else
                                                        <span class="fw-bold">{{ $response->answer }}</span>
                                                    @endif
