                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="bi bi-patch-check fs-2 text-gray-300"></i>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            @forelse($submissions as $index => $submission)
                                ...
                                @if ($submission->status === 'submitted')
                                    <div class="modal fade" id="verifyModal{{ $submission->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('admin.submissions-v2.verify', $submission) }}"
                                                    method="POST">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="rejectModal{{ $submission->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('admin.submissions-v2.reject', $submission) }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="modal-header">
