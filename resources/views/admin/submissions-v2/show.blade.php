                        ...
                        {{-- @if ($pct)
                            <div class="mt-1">
                                <div class="progress mb-1" style="height:6px;background:rgba(255,255,255,0.2);">
                                    <div class="progress-bar bg-{{ $pctColor }}" style="width:{{ $pct }}%">
                                    </div>
                                </div>
                                <small class="">Kelengkapan: {{ number_format($pct, 0) }}%</small>
                            </div>
                        @endif --}}
                    </div>
                </div>
        ...
        <div class="accordion accordion-flush shadow-sm border-0 rounded mb-4" id="detailAccordion">
            ...
            <div class="accordion-item border-0 mb-2 rounded shadow-sm overflow-hidden">
                ...
                <div id="collapseSchool" class="accordion-collapse collapse" data-bs-parent="#detailAccordion">
                    <div class="accordion-body pt-0">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <dl class="row mb-0 mt-3 mt-3" style="row-gap:.5rem;">
            ...
            <div class="accordion-item border-0 mb-2 rounded shadow-sm overflow-hidden">
                ...
                <div id="collapseStatus" class="accordion-collapse collapse" data-bs-parent="#detailAccordion">
                    <div class="accordion-body">
                        ...
                        {{-- Verification / Validation timeline --}}
                        @if ($submission->verified_at || $submission->validated_at)
                                ...
                                <div class="d-flex flex-column gap-3">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="text-muted small">
                                                    {{ $submission->verified_at->format('d M Y, H:i') }}</div>
                                    ...
                                    @if ($submission->validated_at)
                                        <div class="d-flex gap-3">
                                            <div class="flex-shrink-0 text-center" style="width:32px;">
                                                <span
                                                    class="rounded-circle d-inline-flex align-items-center justify-content-center bg-success"
                                                    style="width:28px;height:28px;">
                                                    <i class="bi bi-patch-check text-white" style="font-size:.8rem;"></i>
                                                </span>
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="fw-semibold small">Divalidasi oleh:
                                                    {{ $submission->validator?->name ?? '-' }}</div>
                                                <div class="text-muted small">
                                                    {{ $submission->validated_at->format('d M Y, H:i') }}</div>
                                                @if ($submission->validation_notes)
                                                    <div class="mt-1 p-2 bg-light rounded small text-muted">
                                                        <i
                                                            class="bi bi-chat-left-text me-1"></i>{{ $submission->validation_notes }}
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
            ...
            <div class="accordion-item border-0 rounded shadow-sm overflow-hidden">
                ...
                <div id="collapseMetadata" class="accordion-collapse collapse" data-bs-parent="#detailAccordion">
                    <div class="accordion-body pt-0">
                        <dl class="row mb-0 mt-3" style="row-gap:.5rem;">
                    ...
                    <form action="{{ route('admin.submissions-v2.validate', $submission) }}" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary"><i
                                    class="bi bi-patch-check me-1"></i>Validasi</button>
                        </div>
                    </form>
                </div>
            </div>
