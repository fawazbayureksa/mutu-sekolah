    ...
    <div class="col-lg-4 mb-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label class="text-muted small text-uppercase mb-1">Provinsi</label>
                    <p class="mb-0">{{ $school->province }}</p>
                </div>
                <div>
                    <label class="text-muted small text-uppercase mb-1">Kota/Kabupaten</label>
                    <p class="mb-0">{{ $school->city }}</p>
                </div>
            </div>
        </div>
