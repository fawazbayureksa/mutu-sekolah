...
<head>
    ...
    <title>@yield('title', 'Portal Sekolah - Mutu Sekolah')</title>
...
<body>
    <div class="sidebar">
        <div class="sidebar-header">
            <a href="{{ route('school.dashboard') }}" class="sidebar-brand">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="{{ route('school.submissions.index') }}"
                    class="sidebar-menu-link {{ request()->is('school/submissions*') ? 'active' : '' }}">
        ...
        <nav class="top-navbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted small">
                    {{ Auth::user()->school->school_name ?? Auth::user()->name }}
                </span>
                <div class="dropdown">
    ...
    <form id="sidebar-logout-form" action="{{ route('school.logout') }}" method="POST" class="d-none">
        @csrf
    </form>
