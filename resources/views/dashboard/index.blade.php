                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h3 class="mb-0 fw-bold">
                                            {{ \App\Models\Assessment::where('status', 'submitted')->count() }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <h3 class="mb-0 fw-bold">
                                            {{ \App\Models\Assessment::where('status', 'draft')->count() }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <a href="#" class="text-decoration-none">
                                    <div class="card border-0 bg-success bg-opacity-10 h-100 hover-shadow">
                                        <div class="card-body text-center p-4">
                                            ...
                                            <h6 class="fw-bold text-dark">Data Sekolah</h6>
                                            <p class="text-muted small mb-0">Kelola data sekolah</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
