...
<div class="container py-5">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0">Detail Sekolah</h1>
            <p class="text-muted mb-0">Informasi sekolah dan data pengajuan</p>
        </div>
    </div>

    <div class="card shadow-sm border-0 mb-4" style="background: linear-gradient(135deg, #4e73df 0%, #224abe 100%);">
            ...
            <div class="card shadow-sm border-0 h-100">
                ...
                <div class="card-body">
                    <dl class="row mb-0" style="row-gap:.75rem;">
                        ...
                        <dd class="col-7 mb-0">{{ $school->program_duration ? $school->program_duration . ' tahun' : '-' }}</dd>
                        ...
                        <dd class="col-7 mb-0">
                            @if ($school->approval_status)
                                @php
                                    ...
                                    [$apvCls, $apvTxt] = $apvMap[$school->approval_status] ?? ['secondary', ucfirst($school->approval_status)];
                                @endphp
                            ...
                            @foreach ($recentSubmissions as $sub)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('schools.shared.submission', [$school->share_token, $sub]) }}"
